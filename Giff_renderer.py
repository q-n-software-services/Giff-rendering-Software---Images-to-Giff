...
class Window(QWidget):
    ...
    def lcd_number(self):
        ...
        self.label2 = QLabel("      ONLY use OPEN button i.e. file explorer for images, don't use for selecting folders\n"
                             "      Copy the Image Path and paste in respective box\n"
                             "      Give a custom name to the GIFF file\n"
                             "      *** For Entire folder, Paste the Folder path\n"
                             "      *** donot give any names, it picks name(s) of parent images now")
        ...
        btn3 = QPushButton("  Export all Images as .gif")
